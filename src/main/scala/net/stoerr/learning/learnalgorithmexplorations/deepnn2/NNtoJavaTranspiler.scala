...
import net.stoerr.learning.gpunn.java.{AbstractNNJavaEvaluator, JavaCompilerWithResourceLoad}
import net.stoerr.learning.gpunn.java.JavaCompilerWithResourceLoad
...
class NNtoJavaTranspiler(terms: Set[NNTerm]) {
  ...
  code ++= s"""
              ...
              |import AbstractNNJavaEvaluator;
